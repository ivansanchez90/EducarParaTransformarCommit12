...
// Crea un usuario en Supabase Auth y lo registra en la tabla `usuarios`.
// Si el rol es Docente, además crea su registro en la tabla `docentes`.
//
// Se invoca desde el panel de administración (GestionUsuarios) vía
// supabase.functions.invoke('crear-usuario', ...).
//
